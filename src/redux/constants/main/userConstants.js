...
export const USER_EMAIL_MARKETING_REQUEST = 'USER_EMAIL_MARKETING_REQUEST';
export const USER_EMAIL_MARKETING_SUCCESS = 'USER_EMAIL_MARKETING_SUCCESS';
export const USER_EMAIL_MARKETING_FAIL = 'USER_EMAIL_MARKETING_FAIL';
export const USER_EMAIL_MARKETING_RESET = 'USER_EMAIL_MARKETING_RESET';

export const USER_EMAIL_MARKETING_UPDATE_REQUEST = 'USER_EMAIL_MARKETING_UPDATE_REQUEST';
export const USER_EMAIL_MARKETING_UPDATE_SUCCESS = 'USER_EMAIL_MARKETING_UPDATE_SUCCESS';
export const USER_EMAIL_MARKETING_UPDATE_FAIL = 'USER_EMAIL_MARKETING_UPDATE_FAIL';
export const USER_EMAIL_MARKETING_UPDATE_RESET = 'USER_EMAIL_MARKETING_UPDATE_RESET';
